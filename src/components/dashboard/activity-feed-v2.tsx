...
const CATEGORY_STYLES: Record<AgentActivityItem['category'], string> = {
    ton: 'border-white/[0.1] bg-white/[0.06] text-white',
    ...
    agent_ops: 'border-white/[0.1] bg-white/[0.06] text-white',
...
function ActorPill({ actor }: { actor: AgentActivityItem['actor'] }) {
    if (actor === 'agent') {
        return (
            <span className="inline-flex items-center gap-1 rounded-full border border-[#AB98FF]/20 bg-[#AB98FF]/10 px-2 py-0.5 text-[10px] uppercase tracking-wide text-[#AB98FF]">
                <Bot size={10} />
                Agent
            </span>
        );
            ...
            <div className="space-y-4">
                ...
                <div className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-3">
                    <div className="flex flex-wrap gap-1.5">
                        ...
                        {protocolLabel && (
                            <span className="rounded-full border border-neutral-500/35 bg-white/[0.05] px-2 py-0.5 text-[10px] uppercase tracking-wide text-neutral-500">
                                {protocolLabel}
                            </span>
                        )}
                                    ...
                                    {group.items.map((item) => {
                                        ...
                                        return (
                                            <article
                                                ...
                                                className="relative rounded-2xl border border-white/[0.05] bg-white/[0.02] px-3 py-3 transition-colors hover:border-white/[0.12] hover:bg-white/[0.04] focus:outline-none focus:ring-1 focus:ring-white/20 sm:px-4"
                                            >
                                                <button
                                                    type="button"
