...
export function WithdrawModal({ agent, onClose, onSuccess }: WithdrawModalProps) {
    ...
    const selectedCardClass = (isSelected: boolean): string =>
        isSelected ? 'border-white/25 bg-white/[0.08]' : 'border-white/[0.06] bg-white/[0.02]';
    ...
    return (
        <Modal open={!!agent} onClose={onClose} title={`Withdraw from ${agent.name}`}>
            <div className="flex max-h-[75vh] flex-col">
                            ...
                            <div className="space-y-2">
                                ...
                                {jettonsOpen && (
                                    <div className="relative max-h-60">
                                        ...
                                        {jettonsFade.top && (
                                            <div className="pointer-events-none absolute inset-x-0 top-0 h-5 bg-gradient-to-b from-[#0c0c0e] to-transparent" />
                                        )}
                                        {jettonsFade.bottom && (
                                            <div className="pointer-events-none absolute inset-x-0 bottom-0 h-6 bg-gradient-to-t from-[#0c0c0e] to-transparent" />
                                        )}
                                    </div>
                                )}
                            </div>
                ...
                <div className="mt-3 border-t border-white/[0.08] bg-[#0c0c0e] pt-4">
