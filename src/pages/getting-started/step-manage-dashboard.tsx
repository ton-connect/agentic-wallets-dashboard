        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
                {features.map((feature) => (
                    ...
                    >
                        <feature.icon size={16} className="mb-3 text-neutral-400" />
            ...
            <Link
                to="/dashboard"
                className="inline-flex w-fit items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-medium text-black transition-colors hover:bg-neutral-200"
            >
                Open Dashboard
                <ArrowRight size={14} />
            </Link>
