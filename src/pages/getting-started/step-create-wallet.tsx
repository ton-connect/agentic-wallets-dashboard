    ...
    return (
        <div className="flex flex-col gap-6">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col gap-1 text-sm text-neutral-400">
                            ...
                            <p>
                                ...
                                <span className="text-[#0098EA]/70">→ [Dashboard Create Link]</span>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-col gap-2">
                <p className="text-xs font-medium uppercase tracking-widest text-[#0098EA]">Key points</p>
                <ul className="flex flex-col gap-2">
                    {keyPoints.map((point, i) => (
                        <li key={i} className="flex items-start gap-2.5 text-sm text-neutral-400">
                            <span className="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-[#0098EA]/50" />
                            {point}
                        </li>
                    ))}
                </ul>
