                        ...
                        <tbody>
                            {envVars.map((v) => (
                                <tr key={v.name} className="border-b border-white/[0.04]">
                                    <td className="py-2.5 pr-4 font-mono text-xs text-neutral-400">{v.name}</td>
            ...
            <CollapsibleSection title="Testnet First (Recommended)">
                <div className="flex flex-col gap-3">
                    <p className="text-sm text-neutral-400">
                        ...
                        <code className="font-mono text-xs text-neutral-400">NETWORK</code> env variable to your config:
                    </p>
                            ...
                            <tbody>
                                {deepLinkParams.map((p) => (
                                    <tr key={p.param} className="border-b border-white/[0.04]">
                                        <td className="py-2.5 pr-4 font-mono text-xs text-neutral-400">{p.param}</td>
