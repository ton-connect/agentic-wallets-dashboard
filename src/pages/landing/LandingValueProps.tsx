...
const pillars: { title: string; description: string; icon: ReactNode }[] = [
    {
        ...
        icon: (
            <svg viewBox="0 0 48 48" fill="none" className="h-5 w-5" aria-hidden="true">
                <rect x="4" y="4" width="17" height="17" rx="4" stroke="white" strokeWidth="1.2" />
                ...
                <circle cx="12.5" cy="12.5" r="2" fill="white" opacity="0.6" />
            </svg>
        ),
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 48 48" fill="none" className="h-5 w-5" aria-hidden="true">
                <circle cx="14" cy="16" r="7" stroke="white" strokeWidth="1.2" />
                <line x1="21" y1="16" x2="36" y2="16" stroke="white" strokeWidth="1.2" />
                <line x1="32" y1="16" x2="32" y2="21" stroke="white" strokeWidth="1.2" />
                <line x1="28" y1="16" x2="28" y2="20" stroke="white" strokeWidth="1.2" />
    ...
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 48 48" fill="none" className="h-5 w-5" aria-hidden="true">
                <path d="M24 8V24" stroke="white" strokeWidth="1.2" strokeLinecap="round" />
                <path
